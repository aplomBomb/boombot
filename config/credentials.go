...
type ServerIDs struct {
	GuildID, JukeboxID, McModChID, TihiID, VideosID, BattleStationID, VcInitializerID, BoombotID, DiogoID, BugID, RickyID, AverossID, FurryID disgord.Snowflake
}
