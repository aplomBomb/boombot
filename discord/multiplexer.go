// Package multiplexer provides a simple Discord message route mux that
// parses messages and then executes a matching registered handler, if found.
// multiplexer can be used with both Disgord and the DiscordGo library.
package discord
...
// Multiplexer is the main struct for all multiplexer methods.
...
// New returns a new Discord message route multiplexer
...
func (m *Multiplexer) Route(pattern, desc string, cb HandlerFunc) (*Route, error) {
...
func (m *Multiplexer) FuzzyMatch(msg string) (*Route, []string) {
...
// routes.
func (m *Multiplexer) OnMessageCreate(ds *discordgo.Session, mc *discordgo.MessageCreate) {
